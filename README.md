...
что было произведено в [Исследовании](https://github.com/hotdonkey/etl_exam/blob/main/results/first_look.ipynb).
...
<img src = https://github.com/hotdonkey/etl_exam/blob/main/results/distr.png>

А так же необходимость стандартизации и понижения размерности (из-за наличия мультиколлинеарности).

<img src = https://github.com/hotdonkey/etl_exam/blob/main/results/heatmap.png>
